...
class MathematicScreen extends StatefulWidget {
  const MathematicScreen({super.key});

  @override
  State<MathematicScreen> createState() => _MathematicScreenState();
}
...
class _MathematicScreenState extends State<MathematicScreen> {
  ...
  Future<void> readJson() async {
    ...
    setState(() {
      _items = data["disciplines"]["mathematics"];
    });
  }
