...
class EnvironmentalScienceScreen extends StatefulWidget {
  const EnvironmentalScienceScreen({super.key});

  @override
  State<EnvironmentalScienceScreen> createState() => _EnvironmentalScienceScreenState();
}

class _EnvironmentalScienceScreenState extends State<EnvironmentalScienceScreen> {
List _items = [];
  ...
  Future<void> readJson() async {
    ...
    setState(() {
      _items = data["disciplines"]["environmentalScience"];
    });
  }
                      ...
                      Row(
                        children: [
                          ...
                          const Expanded(
                            ...
                            child: Image(
                                height: 150,
                                image: AssetImage('assets/images/environmental.png')),
                          )
                        ],
                      ),
                      const Text(
